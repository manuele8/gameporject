...
def launch_tor_with_config(config, tor_cmd = r'C:\Users\manue\OneDrive\Desktop\Altro\Browsers\Tor Browser\Browser\TorBrowser\Tor\tor.exe', completion_percent = 100, init_msg_handler = None, timeout = DEFAULT_INIT_TIMEOUT, take_ownership = False, close_output = True):
  """
